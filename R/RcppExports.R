...
ShapeCountsCpp <- function(counts, absolute, totals = TRUE, genotypic = TRUE, allelic = FALSE, percentage = FALSE, extrapolateFreq = TRUE, minFreqAl = 0, minFreqGt = 0) {
...
CheapDataFrameBuilder <- function(list) {
    .Call('_rsurvival_CheapDataFrameBuilder', PACKAGE = 'rsurvival', list)
}
